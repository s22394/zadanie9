...
namespace cw8.Migrations
{
    ...
    [Migration("20220530210333_AddedSeededData")]
            ...
            modelBuilder.Entity("cw8.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2022, 5, 30, 23, 3, 32, 642, DateTimeKind.Local).AddTicks(4927),
                            DueDate = new DateTime(2022, 7, 1, 23, 3, 32, 644, DateTimeKind.Local).AddTicks(6110),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2022, 5, 30, 23, 3, 32, 644, DateTimeKind.Local).AddTicks(6991),
                            DueDate = new DateTime(2022, 8, 10, 23, 3, 32, 644, DateTimeKind.Local).AddTicks(7003),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
