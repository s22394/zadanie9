...
namespace cw8
{
    public class Startup
    {
        ...
        string secret = "fdsfgsdguhindfrsghurdfenhgjirdf,.fehauijkjoiprewoipujwhtrjklgnjmkvbcxnjklzxcvjimopksadefopk[ewqrl;,[asijodfguijhoqwrfikojpvjhuiadshgiujdrfk";
